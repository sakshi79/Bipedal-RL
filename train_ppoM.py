...
def train_ppo(clip_ratio=0.2, gamma=0.99, gae_lambda=0.8, entropy_coef = 1e-4, mini_batch_size=128, 
            actor_lr=3e-4, critic_lr=4e-4, n_epochs=5, T = 2048, n_episodes=1000, hardcore=False):
